...
struct StoryBrain {
    ...
    mutating func nextStory(_ userChoice: String) {
        if(userChoice == stories[sceneNumber].choice1){
            sceneNumber = stories[sceneNumber].choice1Destination
        } else {
            sceneNumber = stories[sceneNumber].choice2Destination
        }
    }
    ...
    func getChoice1() -> String {
        return stories[sceneNumber].choice1
    }
    
    func getChoice2() -> String {
        return stories[sceneNumber].choice2
    }
}
